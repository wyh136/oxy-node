...
describe('GET /api/accounts/getBalance?address=', function () {
	...
	it('using invalid address should fail', function (done) {
		getBalance('thisIsNOTAnOxyAddress', function (err, res) {
			node.expect(res.body).to.have.property('success').to.be.not.ok;
			node.expect(res.body).to.have.property('error').to.eql('Object didn\'t pass validation for format address: thisIsNOTAnOxyAddress');
			done();
		});
	});
...
describe('GET /api/accounts/getPublicKey?address=', function () {
	...
	it('using invalid address should fail', function (done) {
		getPublicKey('thisIsNOTAnOxyAddress', function (err, res) {
			node.expect(res.body).to.have.property('success').to.be.not.ok;
			node.expect(res.body).to.have.property('error').to.contain('Object didn\'t pass validation for format address: thisIsNOTAnOxyAddress');
			done();
		});
	});
...
describe('GET /accounts', function () {
	...
	it('using invalid address should fail', function (done) {
		getAccounts('thisIsNOTAnOxyAddress', function (err, res) {
			node.expect(res.body).to.have.property('success').to.be.not.ok;
			node.expect(res.body).to.have.property('error');
			node.expect(res.body.error).to.contain('Object didn\'t pass validation for format address: thisIsNOTAnOxyAddress');
			done();
		});
	});
	...
	it('using invalid publicKey should fail', function (done) {
		getAccounts('publicKey=' + 'thisIsNOTAnOxyAccountPublicKey', function (err, res) {
			node.expect(res.body).to.have.property('success').to.be.not.ok;
			node.expect(res.body).to.have.property('error');
			node.expect(res.body.error).to.contain('Object didn\'t pass validation for format publicKey: thisIsNOTAnOxyAccountPublicKey');
			done();
		});
	});
