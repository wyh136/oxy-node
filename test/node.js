...
node.normalizer = 100000000; // Use this to convert OXY amount to normal value
...
// Random amount
node.OXY = Math.floor(Math.random() * (100000 * 100000000)) + 1;
